  ...
  //FIN PRY-0890 - JESPINOZA
   ...
   var carga_combo=0;                             
          ...
          //  <%=request.getSession().getAttribute("statusSeccionDigitalizacion")%> .
            ...
            document.forms[0].btnSeleccionar.disabled=true; 
             var req = newXMLHttpRequest();          
              ...
              //txtcedente
                        req.open("GET","<%=request.getContextPath() %>/OrderActionMultiple.do?metodo=PortabilidadAnt&imei=" + imei+"&txtnumeroPortabilidad="+txtTelefonoAPortar+"&cmbCedente="+cmbCedente+"&cmbOrigen="+cmbOrigen+"&cmbTipoDocumento="+cmbTipoDocumento+"&txtNumeroDocumento="+txtNumeroDocumento,true);
             ...
             else  // si hay 1 o más checkboxs marcados...
             {
                   ...
                   {            
                    ...
                    if(flag && flag2 && flag3 && !valor){
                        ...
                        req.open("GET","<%=request.getContextPath() %>/OrderActionMultiple.do?metodo=ValidaPorta&imei=" + strImei,true);
                        req.setRequestHeader("Content-Type","application/ISO-8859-1");
                        req.send(null);           
                    }
                    else
            ...
            function jsValidarPortabilidad(){                
              ...
              if(!PortaPhoneNumberValidate(txtTelefonoAPortar)){
                 ...
                 return false;
                    ...
                    var req = newXMLHttpRequest();          
                     req.onreadystatechange = getReadyStateHandler(req,updatePorta);
                     req.open("GET","<%=request.getContextPath() %>/OrderActionMultiple.do?metodo=PortabilidadAnt&imei=" + $.trim(imei)+"&txtnumeroPortabilidad="+$.trim(txtTelefonoAPortar)+"&cmbCedente="+cmbCedente+"&cmbOrigen="+cmbOrigen+"&cmbTipoDocumento="+cmbTipoDocumento+"&txtNumeroDocumento="+$.trim(txtNumeroDocumento),true);
                     req.setRequestHeader("Content-Type","application/ISO-8859-1");
                     req.send(null); 
    ...
    function PortaPhoneNumberValidatePrefijo(phonenumber) {
         ...
         var status=false;
         var req = newXMLHttpRequest();   
         var strResponse = "<%=request.getContextPath()%>/OrderActionMultiple.do?metodo=PortaPhoneNumberValidatePrefijo&phonenumber="+$.trim(phonenumber); 
...
function PortaPhoneNumberValidate(phonenumber){
  var strUrlWithParams = "<%=request.getContextPath()%>/OrderActionMultiple.do?metodo=PortaPhoneNumberValidate&phonenumber="+phonenumber;
  var response=true;
  var flagPrimero = 1;
  var checks = document.getElementsByName('checkbox');
  var selectedImeis ="";
...
function validarSim(valor)
{
        ...
        frm.indice.value =  valor;
                ...
                req.open("GET","<%=request.getContextPath() %>/OrderActionMultiple.do?metodo=searchSim&indice=" + valor+"&splitImeis="+imei,true);
                req.setRequestHeader("Content-Type","application/ISO-8859-1");
                req.send(null);
    ...
    function cargarModelo()
{
    ...
    var cmbSoluction=document.forms[0].cmbSoluction.value
     ...
     var modelo="modelo"
    var req = newXMLHttpRequest();          
    req.onreadystatechange = getReadyStateHandler(req,updateModelo);
    req.open("GET","<%=request.getContextPath() %>/OrderActionMultiple.do?metodo=orderDetail&cmbSoluction="+cmbSoluction+"&cmbLineaProducto="+cmbLineaProducto+"&modelo="+modelo,true);
    req.setRequestHeader("Content-Type","application/ISO-8859-1");
    req.send(null);
}
    
    function updateModelo(miXml){
                 var subCate = miXml.getElementsByTagName("modelo")[0];
		var sol = subCate.getElementsByTagName("solucion");
		document.forms[0].cmbProduct.length = sol.length+1;
		               
		for (var i=0;i<sol.length;i++){
                        var item = sol[i];
                        var myString = item.firstChild.nodeValue;
                        var trozo = myString.split(";");
                        document.forms[0].cmbProduct.options[i+1].value = trozo[0];
                        document.forms[0].cmbProduct.options[i+1].text = trozo[1];
		}
...
function newXMLHttpRequest(){
 ...
 function autocompleteImei(obj,valor){
     var frm = document.forms[0];
     frm.indice.value =  valor;
     var pages = "<%=request.getContextPath() %>/OrderActionMultiple.do?metodo=obtenerImei&indice="+valor;
...
<td>
  ...
  <table width="100%"  border="0">
    ...
    <tr class="ListRow1">
      ...
      <td width="17%">
      <html:select property="cmbLineaProducto" styleId="cmbLineaProducto" disabled="${statusCmbLineaProducto}" onchange="javascript:cargarModelo();">
      <option value="0" >--Seleccionar--</option>
    ...
    <tr class="ListRow1">
      ...
      <html:select property="cmbProduct" styleId="cmbProduct">
      <option value="0" >--Seleccionar--</option>
       ...
       <table width="100%"  border="0">    
        ...
        <tr class="ListRow1"><td><span class="PortletText1">Lista de Productos</span></td></tr>
              ...
              <div id="div_producto_<%=indice%>">                    
                    <table width="100%" align="center">
                        <tr> <%
                            System.out.println("codproducto="+codproductoPorta);
...
<!--  <logic:notEqual value="<%=productoSerie%>" name="OrderForm" property="idSpecification">-->
  <table width="100%"  border="0">
    <tr class="ListRow1">
      ...
      <td width="18%" class="LeftSubTab"><div align="center"><strong>Promoci&oacute;n</strong></div></td>
      <td width="6%" class="LeftSubTab"><div align="center"><strong>SKU</strong></div></td>
      <td width="4%" class="LeftSubTab"><div align="center"><strong>Precio</strong></div></td>
      <td width="16%" class="LeftSubTab"><div align="center"><strong>Plan</strong></div></td>
    ...
    if(idSpecification_product_prePago_portability == (Integer)request.getSession().getAttribute("idSpecificationSelection") || idSpecification_product_postPago_portability == (Integer)request.getSession().getAttribute("idSpecificationSelection"))                  
     { %>
      <td width="13%" class="LeftSubTab"><div align="center"><strong>PORTABILIDAD</strong></div></td>  
<% } else{%>
      <td width="13%" class="LeftSubTab"><div align="center"><strong>Regi&oacute;n</strong></div></td>      
  ...
  <logic:notEmpty name="OrderForm" property="tempListaOrdenes">
      ...
      <td width="8%" class="ListRow1"><div align="center"><input name='existe[]' type='hidden' ><input name='txtIdKitArray[]' type='hidden' value="<bean:write name="detail" property="idKitProducto"/>"><a href='javascript:eliminarItem(<%=idItem%>);'><img src='images/Eliminar.gif' width='16' height='15' title='Eliminar' border='0'></a></div></td>
      <td width="18%" class="ListRow1"><div align="center"><input name='txtNameKitArray[]' type='hidden' value="<bean:write name="detailFinal" property="nameKit"/>"><bean:write name="detailFinal" property="nameKit"/></div></td>
      <td width="6%" class="ListRow1"><div align="center"><input name='txtSkuKitArray[]' type='hidden' value="<bean:write name="detailFinal" property="skuKit"/>"><bean:write name="detailFinal" property="skuKit"/></div></td>
      <td width="0%" class="ListRow1"><div align="center"><input name='txtCurrencyArray[]' type='hidden' value="<bean:write name="detail" property="idMoneda"/>"></div></td>
      <td width="4%" class="ListRow1"><div align="right"><input name='txtCostKitArray[]' type='hidden' value="<bean:write name="detailFinal" property="cost"/>"><bean:write name="detailFinal" property="cost"/></div></td>
      <%}else{%>
       <td width="8%" class="ListRow1"><div align="center"></div></td>
       <td width="18%" class="ListRow1"><div align="center"></div></td>
       <td width="6%" class="ListRow1"><div align="center"></div></td>
       <td width="4%" class="ListRow1"><div align="center"></div></td>
       <%}productoAnterior = idItem.toString();%>
      <td width="0%" class="ListRow1"><div align="center"><input name='txtIdPlanArray[]' type='hidden' value="<bean:write name="detail" property="idPlan"/>"></div></td>
      <td width="16%" class="ListRow1"><div align="center"><input name='txtPlanNameArray[]' type='hidden' value="<bean:write name="detailFinal" property="namePlan"/>"><bean:write name="detailFinal" property="namePlan"/></div></td>
      <td width="0%" class="ListRow1"><div align="center"><input name='txtIdProductArray[]' type='hidden' value="<bean:write name="detail" property="idProducto"/>"></div></td>
      <td width="12%" class="ListRow1"><div align="center"><input name='txtModelNameArray[]' type='hidden' value="<bean:write name="detailFinal" property="nameModel"/>"><bean:write name="detailFinal" property="nameModel"/></div></td>
      <td width="11%" class="ListRow1"><div align="center"><input name='txtImeiArray2[]' type='hidden' value="<bean:write name="detailFinal" property="imei"/>"><bean:write name="detailFinal" property="imei"/></div></td>
      <td width="13%" class="ListRow1"><div align="center"><bean:write name="detailFinal" property="sim"/></div></td>
       <%
             if(idSpecification_product_prePago_portability == (Integer)request.getSession().getAttribute("idSpecificationSelection") || idSpecification_product_postPago_portability == (Integer)request.getSession().getAttribute("idSpecificationSelection"))                  
             { %>
                <td width="100" class="ListRow1"> <a id="idportabilidad" name="idportabilidad" data="<bean:write name="detail" property="idKitProducto"/>" class="popup_view" value="aaaa"  href="#" title="Iniciar Sesi&oacute;n">Portabilidad</a></td>
           <% }else {%>
           <logic:notEmpty name="detailFinal" property="lstRegiones">
                <td width="100" class="ListRow1"><div align="center">              
                
                <select name="txtRegionArrayFinal[]" class="combo validateComboRegion">
                <option value="0" >--Seleccionar--</option>
        ...
        <logic:empty name="detailFinal" property="lstRegiones">
            <td width="100">
            <select name="txtRegionArrayFinal[]" class="combo" style="display:none">
                <option value="0" >--Seleccionar--</option>
            </select>
            </td>
        </logic:empty>        
